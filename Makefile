...
# Project:  GUI/GUI.pro
# Template: app
# Command: /opt/homebrew/opt/qt/bin/qmake -o Makefile GUI/GUI.pro -spec macx-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = GUI1.0.0
DISTDIR = /Users/avgustine/Project_cpp/.tmp/GUI1.0.0
...
SOURCES       = GUI/main.cpp \
		...
		GUI/modelview.cpp \
		GUI/proxymodel.cpp \
		GUI/rightaligneddelegate.cpp moc_mainwindow.cpp \
		moc_modelview.cpp \
		moc_proxymodel.cpp
OBJECTS       = main.o \
		mainwindow.o \
		modelview.o \
		proxymodel.o \
		rightaligneddelegate.o \
		moc_mainwindow.o \
		moc_modelview.o \
		moc_proxymodel.o
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/macx.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/sanitize.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/gcc-base.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/gcc-base-mac.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/clang.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/clang-mac.conf \
		...
		GUI/GUI/GUI.pro GUI/Core/k-means.h \
		GUI/Core/header.h \
		GUI/Core/point.h \
		GUI/Core/silhouette.h \
		GUI/Core/logger.h \
		GUI/Core/point.h \
		GUI/Core/readFromCSV.h \
		GUI/Core/respondent.h \
		GUI/Core/respondentToPoint.h \
		GUI/Core/silhouette.h \
		GUI/Core/clusteringAlgorithm.h \
		GUI/Core/clusteringResult.h \
		GUI/mainwindow.h \
		GUI/modelview.h \
		GUI/proxymodel.h \
		GUI/rightaligneddelegate.h GUI/main.cpp \
		GUI/mainwindow.cpp \
		GUI/modelview.cpp \
		GUI/proxymodel.cpp \
		GUI/rightaligneddelegate.cpp
QMAKE_TARGET  = GUI
DESTDIR       = 
...
EXPORT__PRO_FILE_ = /Users/avgustine/Project_cpp/GUI/GUI.pro


include /opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

GUI.app/Contents/MacOS/GUI: ui_mainwindow.h $(OBJECTS)  
	@test -d GUI.app/Contents/MacOS/ || mkdir -p GUI.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: GUI/GUI.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.2_2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile GUI/GUI.pro -spec macx-clang CONFIG+=debug CONFIG+=qml_debug
...
GUI.app/Contents/Info.plist: 
	...
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.GUI,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.GUI,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,GUI,g" -e "s,@LIBRARY@,GUI,g" -e "s,\$${EXECUTABLE_NAME},GUI,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >GUI.app/Contents/Info.plist
...
distdir: FORCE
	...
	$(COPY_FILE) --parents GUI/Core/k-means.h GUI/Core/header.h GUI/Core/point.h GUI/Core/silhouette.h GUI/Core/logger.h GUI/Core/point.h GUI/Core/readFromCSV.h GUI/Core/respondent.h GUI/Core/respondentToPoint.h GUI/Core/silhouette.h GUI/Core/clusteringAlgorithm.h GUI/Core/clusteringResult.h GUI/mainwindow.h GUI/modelview.h GUI/proxymodel.h GUI/rightaligneddelegate.h $(DISTDIR)/
	$(COPY_FILE) --parents GUI/main.cpp GUI/mainwindow.cpp GUI/modelview.cpp GUI/proxymodel.cpp GUI/rightaligneddelegate.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_modelview.cpp moc_proxymodel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_modelview.cpp moc_proxymodel.cpp
moc_mainwindow.cpp: GUI/mainwindow.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/avgustine/Project_cpp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/avgustine/Project_cpp/GUI -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib GUI/mainwindow.h -o moc_mainwindow.cpp

moc_modelview.cpp: GUI/modelview.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractTableModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QVariant \
		/opt/homebrew/lib/QtCore.framework/Headers/qvariant.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/avgustine/Project_cpp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/avgustine/Project_cpp/GUI -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib GUI/modelview.h -o moc_modelview.cpp

moc_proxymodel.cpp: GUI/proxymodel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QSortFilterProxyModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qsortfilterproxymodel.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/avgustine/Project_cpp/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/avgustine/Project_cpp/GUI -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib GUI/proxymodel.h -o moc_proxymodel.cpp
...
ui_mainwindow.h: GUI/mainwindow.ui \
	...
	/opt/homebrew/share/qt/libexec/uic GUI/mainwindow.ui -o ui_mainwindow.h
...
modelview.o: GUI/modelview.cpp GUI/modelview.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractTableModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QVariant \
		/opt/homebrew/lib/QtCore.framework/Headers/qvariant.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modelview.o GUI/modelview.cpp

proxymodel.o: GUI/proxymodel.cpp GUI/proxymodel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QSortFilterProxyModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qsortfilterproxymodel.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o proxymodel.o GUI/proxymodel.cpp

rightaligneddelegate.o: GUI/rightaligneddelegate.cpp GUI/rightaligneddelegate.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QStyledItemDelegate \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qstyleditemdelegate.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QStyleOptionViewItem \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qstyleoption.h \
		/opt/homebrew/lib/QtGui.framework/Headers/QPainter \
		/opt/homebrew/lib/QtGui.framework/Headers/qpainter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o rightaligneddelegate.o GUI/rightaligneddelegate.cpp
...
moc_proxymodel.o: moc_proxymodel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_proxymodel.o moc_proxymodel.cpp
